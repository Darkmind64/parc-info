...
**Version** : 2.19.39 ⭐ **Scan réseau (SNMP + capture passive) et interface mobile enrichie**  
...
- [system-info-collector.exe (CLI)](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/system-info-collector.exe)
- [system-info-collector-gui.exe (GUI)](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/system-info-collector-gui.exe)
- [ParcInfo-Windows.exe (Serveur)](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/ParcInfo-Windows.exe)
...
## 📥 Téléchargements v2.19.39

### Exécutables Portables

| Plateforme | Télécharger |
|-----------|----------|
| **Windows** | [ParcInfo-Windows.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/ParcInfo-Windows.exe) |
| **macOS (Apple Silicon)** | [ParcInfo-macOS-ARM.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/ParcInfo-macOS-ARM.zip) |
| **macOS (Intel)** | [ParcInfo-macOS-Intel.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/ParcInfo-macOS-Intel.zip) |
| **Docker** | `docker pull darkmind64/parcinfo:v2.19.39` |

### Collecteurs Système (Exécutables Autonomes)

| Type | Plateforme | Télécharger | Usage |
|------|-----------|----------|-------|
| **GUI** ⭐ | Windows | [system-info-collector-gui.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/system-info-collector-gui.exe) | Double-clic → interface |
| **CLI** | Windows | [system-info-collector.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/system-info-collector.exe) | Automatisation/scripts |
| **CLI** | macOS (Intel) | [system-info-collector-macOS-Intel.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/system-info-collector-macOS-Intel.zip) | Dézipper → binaire en ligne de commande |
| **GUI** | macOS (Intel) | [system-info-collector-gui-macOS-Intel.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.19.39/system-info-collector-gui-macOS-Intel.zip) | Dézipper → `ParcInfo-Collector.app` |
...
👉 [Voir la release complète](https://github.com/Darkmind64/parc-info/releases/tag/v2.19.39)
