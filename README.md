...
**Version** : 2.8.3 ⭐ **Téléchargement reprenable, alignements de la fiche**  
...
### 🎉 v2.8.3 : Téléchargement reprenable, fiche système alignée
...
- [system-info-collector.exe (CLI)](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/system-info-collector.exe)
- [system-info-collector-gui.exe (GUI)](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/system-info-collector-gui.exe)
- [ParcInfo-Windows.exe (Serveur)](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/ParcInfo-Windows.exe)
...
## 📥 Téléchargements v2.8.3

### Exécutables Portables

| Plateforme | Télécharger |
|-----------|----------|
| **Windows** | [ParcInfo-Windows.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/ParcInfo-Windows.exe) |
| **macOS (Apple Silicon)** | [ParcInfo-macOS-ARM.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/ParcInfo-macOS-ARM.zip) |
| **Docker** | `docker pull darkmind64/parcinfo:v2.8.3` |

### Collecteurs Système (Exécutables Autonomes)

| Type | Plateforme | Télécharger | Usage |
|------|-----------|----------|-------|
| **GUI** ⭐ | Windows | [system-info-collector-gui.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/system-info-collector-gui.exe) | Double-clic → interface |
| **CLI** | Windows | [system-info-collector.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.8.3/system-info-collector.exe) | Automatisation/scripts |
...
👉 [Voir la release complète](https://github.com/Darkmind64/parc-info/releases/tag/v2.8.3)
