...
**Version** : 2.32.3 ⭐ **Audit approfondi des fonctionnalités réseau → 4 correctifs, dont un important : le relevé SNMP multi-colonnes plafonnait à ~600 varbinds (et non 600 lignes) → sur un switch 48 ports interrogé sur ~20 colonnes, la moitié des ports étaient silencieusement absents du diagnostic et de la topologie. — Baux DHCP relevés à la source, scan réseau récurrent planifié, recherche globale `Ctrl+K`, score de santé par appareil.**  
...
- [system-info-collector.exe (CLI)](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/system-info-collector.exe)
- [system-info-collector-gui.exe (GUI)](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/system-info-collector-gui.exe)
- [ParcInfo-Windows.exe (Serveur)](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/ParcInfo-Windows.exe)
...
## 📥 Téléchargements v2.32.3

### Exécutables Portables

| Plateforme | Télécharger |
|-----------|----------|
| **Windows** | [ParcInfo-Windows.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/ParcInfo-Windows.exe) |
| **macOS (Apple Silicon)** | [ParcInfo-macOS-ARM.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/ParcInfo-macOS-ARM.zip) |
| **macOS (Intel)** | [ParcInfo-macOS-Intel.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/ParcInfo-macOS-Intel.zip) |
| **Docker** | `docker pull darkmind64/parcinfo:v2.32.3` |

### Collecteurs Système (Exécutables Autonomes)

| Type | Plateforme | Télécharger | Usage |
|------|-----------|----------|-------|
| **GUI** ⭐ | Windows | [system-info-collector-gui.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/system-info-collector-gui.exe) | Double-clic → interface |
| **CLI** | Windows | [system-info-collector.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/system-info-collector.exe) | Automatisation/scripts |
| **CLI** | macOS (Intel) | [system-info-collector-macOS-Intel.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/system-info-collector-macOS-Intel.zip) | Dézipper → binaire en ligne de commande |
| **GUI** | macOS (Intel) | [system-info-collector-gui-macOS-Intel.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.32.3/system-info-collector-gui-macOS-Intel.zip) | Dézipper → `ParcInfo-Collector.app` |
...
👉 [Voir la release complète](https://github.com/Darkmind64/parc-info/releases/tag/v2.32.3)
