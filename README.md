...
**Version** : 2.6.32 ⭐ **Fiche système graphique, périphériques USB inventoriés automatiquement**  
...
### 🎉 v2.6.32 : Rapports graphiques + inventaire USB automatique
...
- [system-info-collector.exe (CLI)](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/system-info-collector.exe)
- [system-info-collector-gui.exe (GUI)](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/system-info-collector-gui.exe)
- [ParcInfo-Windows.exe (Serveur)](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/ParcInfo-Windows.exe)
...
## 📥 Téléchargements v2.6.32

### Exécutables Portables

| Plateforme | Télécharger |
|-----------|----------|
| **Windows** | [ParcInfo-Windows.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/ParcInfo-Windows.exe) |
| **macOS (Apple Silicon)** | [ParcInfo-macOS-ARM.zip](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/ParcInfo-macOS-ARM.zip) |
| **Docker** | `docker pull darkmind64/parcinfo:v2.6.32` |

### Collecteurs Système (Exécutables Autonomes)

| Type | Plateforme | Télécharger | Usage |
|------|-----------|----------|-------|
| **GUI** ⭐ | Windows | [system-info-collector-gui.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/system-info-collector-gui.exe) | Double-clic → interface |
| **CLI** | Windows | [system-info-collector.exe](https://github.com/Darkmind64/parc-info/releases/download/v2.6.32/system-info-collector.exe) | Automatisation/scripts |
...
👉 [Voir la release complète](https://github.com/Darkmind64/parc-info/releases/tag/v2.6.32)
