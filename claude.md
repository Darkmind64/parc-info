...
**Dernier update** : 2026-09-02 (v2.19.11 — Vue d'activité baie : démarrage des LEDs en ~30 s au lieu de 2-3 min (cadence courte forcée sur les premiers cycles `_activite_rechauffe` + bandeau « démarrage du relevé… » + thread lancé 2 s après la 1re requête))
